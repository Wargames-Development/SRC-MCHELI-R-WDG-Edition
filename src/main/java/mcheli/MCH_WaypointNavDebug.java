...
public final class MCH_WaypointNavDebug {

    private static final Object LOCK = new Object();
    private static final SimpleDateFormat TS_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    private static final String LOG_PATH = "logs/mcheli_waypointnav_debug.log";
    private static PrintWriter writer = null;

    private MCH_WaypointNavDebug() {
    }
    ...
    public static void trace(World world, Entity actor, String format, Object... data) {
        ...
        MCH_Lib.Log(world, "[WaypointNavDebug] %s", msg);
        appendLine(line);
        if (actor instanceof EntityPlayer) {
            ((EntityPlayer) actor).addChatMessage(new ChatComponentText("[WaypointNavDebug] " + msg));
        }
    }
