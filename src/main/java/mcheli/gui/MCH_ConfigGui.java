...
public class MCH_ConfigGui extends W_GuiContainer {
    ...
    public void initGui() {
        ...
        boolean var13 = true;
        boolean var14 = true;
        MCH_GuiListItemKeyBind[] listKeyBindItems = new MCH_GuiListItemKeyBind[32];
        ...
        listKeyBindItems[31] = new MCH_GuiListItemKeyBind(231, 331, x1, MCH_I18n.format("gui.mcheli.key.toggle_radar"), MCH_Config.KeyRadarSwitch);
