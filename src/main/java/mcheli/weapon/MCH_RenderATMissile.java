...
public class MCH_RenderATMissile extends MCH_RenderBulletBase {


   public MCH_RenderATMissile() {
   ...
   public void renderBullet(Entity entity, double posX, double posY, double posZ, float par8, float par9) {
      if(entity instanceof MCH_EntityATMissile) {
         MCH_EntityATMissile aam = (MCH_EntityATMissile) entity;
