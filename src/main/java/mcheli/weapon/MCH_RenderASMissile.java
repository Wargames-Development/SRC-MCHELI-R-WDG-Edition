    ...
    public void doRender(Entity entity, double posX, double posY, double posZ,
        ...
        if (entity instanceof MCH_EntityBaseBullet) {
            ...
            if (aam.getInfo() != null && aam.getInfo().enableExhaustFlare) {
                // Interpolate motion vector for smoother transition
                ...
                GL11.glPushMatrix();
                // Move to the missile’s position
                GL11.glTranslated(posX, posY, posZ);
                // Offset slightly backward along the inverse of motion direction so the exhaust appears at the tail
                ...
                // Billboard: rotate by (180° − playerViewY) and −playerViewX so the flare quad always faces the player
