...
//                if(ac == null) return;
            ...
            if (!worldObj.isRemote) {
                ...
                if(ac != null) {
                    if (!ac.isUAV()) {
                        double interpolatedPosX = e.prevPosX + (e.posX - e.prevPosX) * 0.5;
                        double interpolatedPosY = e.prevPosY + (e.posY - e.prevPosY) * 0.5;
                        double interpolatedPosZ = e.prevPosZ + (e.posZ - e.prevPosZ) * 0.5;
                        posX = interpolatedPosX;
                        posY = interpolatedPosY + e.getEyeHeight();
