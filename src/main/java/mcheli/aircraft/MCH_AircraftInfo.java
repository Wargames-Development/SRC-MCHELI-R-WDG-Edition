                                                                        ...
                                                                        if (!item.equalsIgnoreCase("AddPartLG") && !item.equalsIgnoreCase("AddPartSlideRotLG") && !item.equalsIgnoreCase("AddPartLGRev") && !item.equalsIgnoreCase("AddPartLGHatch")) {
                                                                            if (item.equalsIgnoreCase("AddPartThrottle")) {
                                                                                ...
                                                                                if (s.length == 5 || s.length == 6) {
                                                                                    ...
                                                                                    MCH_BoundingBox var49 = new MCH_BoundingBox(this.toFloat(s[0]), this.toFloat(s[1]), this.toFloat(s[2]), this.toFloat(s[3]), this.toFloat(s[4]), var15);
                                                                                    ...
                                                                                    this.markerWidth = (float) Math.max(this.markerWidth, Math.abs(var49.boundingBox.maxX) / 2.0D);
                                                                                    this.markerWidth = (float) Math.max(this.markerWidth, Math.abs(var49.boundingBox.minX) / 2.0D);
                                                                                    this.markerWidth = (float) Math.max(this.markerWidth, Math.abs(var49.boundingBox.maxZ) / 2.0D);
                                                                                    this.markerWidth = (float) Math.max(this.markerWidth, Math.abs(var49.boundingBox.minZ) / 2.0D);
                                                                                    this.bbZmin = (float) Math.min(this.bbZmin, var49.boundingBox.minZ);
