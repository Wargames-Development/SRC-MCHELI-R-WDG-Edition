...
public class MCH_Flare {
   ...
   public MCH_Flare(World w, MCH_EntityAircraft ac) {
      ...
      if(FLARE_DATA == null) {
         ...
         FLARE_DATA[1] = new MCH_Flare.FlareParam(1, 3, 200 + delay, 100, 6);
         FLARE_DATA[2] = new MCH_Flare.FlareParam(3, 5, 300 + delay, 200, 6);
         FLARE_DATA[3] = new MCH_Flare.FlareParam(2, 3, 200 + delay, 100, 6);
         FLARE_DATA[4] = new MCH_Flare.FlareParam(1, 3, 200 + delay, 100, 6);
         FLARE_DATA[5] = new MCH_Flare.FlareParam(2, 3, 200 + delay, 100, 6);
