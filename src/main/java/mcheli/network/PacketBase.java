...
/** Base class for all packets in MCH. */
public abstract class PacketBase 
{
	/** Encode the packet into a ByteBuf.
	 * Advanced data handlers can be found at {@link cpw.mods.fml.common.network.ByteBufUtils}.
	 */
	...
	/** Utility method for quickly writing strings. */
	public void writeUTF(ByteBuf data, String s)
	{
		ByteBufUtils.writeUTF8String(data, s);
	}

	/** Utility method for quickly reading strings. */
