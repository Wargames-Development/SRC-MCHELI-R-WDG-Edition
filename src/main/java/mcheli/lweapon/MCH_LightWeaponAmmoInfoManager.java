...
public class MCH_LightWeaponAmmoInfoManager {

    private static final Map<String, MCH_LightWeaponAmmoInfo> map = new LinkedHashMap<String, MCH_LightWeaponAmmoInfo>();
    ...
    public static boolean load(String path) {
        ...
        for (File f : files) {
            ...
            try {
                ...
                if (!map.containsKey(key) && inFile.openUTF8(f)) {
                    MCH_LightWeaponAmmoInfo info = new MCH_LightWeaponAmmoInfo(key);
        ...
        MCH_Lib.Log("[mcheli] Read %d light-weapon ammos", map.size());
        return map.size() > 0;
    }

    public static MCH_LightWeaponAmmoInfo get(String name) {
        return map.get(name);
    }
    ...
    public static Collection<MCH_LightWeaponAmmoInfo> getValues() {
        return map.values();
    }
}
