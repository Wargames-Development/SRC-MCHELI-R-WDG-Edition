...
public class MCH_I18n {
    ...
    public static void register() {
        ...
        addTranslation("gui.mcheli.key.zoom_fold_wing", "zh_CN", "炮镜缩放/折叠机翼");
        ...
        addTranslation("gui.mcheli.key.third_person_distance_up", "zh_CN", "第三人称视距增大");
        addTranslation("gui.mcheli.key.third_person_distance_down", "en_US", "Third Person Distance Down");
        addTranslation("gui.mcheli.key.third_person_distance_down", "zh_CN", "第三人称视距减小");
        ...
        addTranslation("gui.mcheli.key.gear_up_down", "zh_CN", "起落架收放");
