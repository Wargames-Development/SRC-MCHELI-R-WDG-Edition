...
public class MCH_ConfigPrm {
    ...
    public String toString() {
        return this.type == 0 ? String.valueOf(this.prmInt) : (this.type == 1 ? this.prmString : (this.type == 2 ? String.valueOf(this.prmBool) : (this.type == 3 ? String.format("%.2f", new Object[]{Double.valueOf(this.prmDouble)}).replace(',', '.') : "")));
    }
