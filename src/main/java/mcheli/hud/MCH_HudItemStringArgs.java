...
public enum MCH_HudItemStringArgs {
    ...
    SPEED,
    KEY_FLARE, KEY_CHAFF, KEY_APS, KEY_MAINTENANCE, KEY_SWEEPWING, KEY_CAMERAMODE, KEY_VTOL,
    COOLDOWN_FLARE, COOLDOWN_CHAFF, COOLDOWN_APS, COOLDOWN_MAINTENANCE, G_FORCE;
