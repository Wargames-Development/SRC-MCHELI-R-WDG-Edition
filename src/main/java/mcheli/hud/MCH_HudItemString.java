...
public class MCH_HudItemString extends MCH_HudItem {
        ...
        for (int i = 0; i < prm.length; ++i) {
            switch (MCH_HudItemString.NamelessClass1090813585.$SwitchMap$mcheli$hud$MCH_HudItemStringArgs[this.args[i].ordinal()]) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    prm[i] = MCH_HudItem.ac.getMaxHP();
                    break;
                case 8:
                    prm[i] = MCH_HudItem.ac.getHP();
                    break;
                case 9:
                    prm[i] = hp_per * 100.0D;
                    break;
                case 10:
                    prm[i] = MCH_HudItem.ac.posX;
                    break;
                case 11:
                    prm[i] = MCH_HudItem.ac.posY;
                    break;
                case 12:
                    prm[i] = MCH_HudItem.ac.posZ;
                    break;
                case 13:
                    prm[i] = MCH_HudItem.ac.motionX;
                    break;
                case 14:
                    prm[i] = MCH_HudItem.ac.motionY;
                    break;
                case 15:
                    prm[i] = MCH_HudItem.ac.motionZ;
                    break;
                case 16:
                    prm[i] = MCH_HudItem.ac.getSizeInventory();
                    break;
                case 17:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    prm[i] = MCH_HudItem.ReloadPer;
                    if (MCH_HudItem.CurrentWeapon == null) {
                        return;
                    }
                    break;
                case 21:
                    prm[i] = MCH_HudItem.ReloadSec;
                    if (MCH_HudItem.CurrentWeapon == null) {
                        return;
                    }
                    break;
                case 22:
                    prm[i] = MCH_HudItem.MortarDist;
                    if (MCH_HudItem.CurrentWeapon == null) {
                        return;
                    }
                    break;
                ...
                case 24:
                    ...
                    break;
                case 25:
                    prm[i] = "MCHeli Reforged";
                    break;
                case 26:
                    prm[i] = MCH_Lib.getRotate360(MCH_HudItem.ac.getRotYaw() + 180.0F);
                    break;
                case 27:
                    prm[i] = -MCH_HudItem.ac.getRotPitch();
                    break;
                case 28:
                    prm[i] = MathHelper.wrapAngleTo180_float(MCH_HudItem.ac.getRotRoll());
                    break;
                case 29:
                    prm[i] = MCH_Lib.getRotate360(MCH_HudItem.player.rotationYaw + 180.0F);
                    break;
                case 30:
                    prm[i] = -MCH_HudItem.player.rotationPitch;
                    break;
                case 31:
                    prm[i] = MCH_HudItem.TVM_PosX;
                    break;
                case 32:
                    prm[i] = MCH_HudItem.TVM_PosY;
                    break;
                case 33:
                    prm[i] = MCH_HudItem.TVM_PosZ;
                    break;
                case 34:
                    prm[i] = MCH_HudItem.TVM_Diff;
                    break;
                case 35:
                    prm[i] = MCH_HudItem.ac.camera.getCameraZoom();
                    break;
                case 36:
                    prm[i] = MCH_HudItem.UAV_Dist;
                    break;
                case 37:
                    ...
                    break;
                case 38:
                    prm[i] = MCH_HudItem.ac.getCurrentThrottle() * 100.0D;
                   break;
                case 39:
    ...
    static class NamelessClass1090813585 {
        ...
        static {
           ...
           try {
              $SwitchMap$mcheli$hud$MCH_HudItemStringArgs[MCH_HudItemStringArgs.AIRBURST_DIST.ordinal()] = 39;
           } catch (NoSuchFieldError var2) {
              ;
           }
