...
public class MCH_Config {
    ...
    public static MCH_ConfigPrm EnableTechTreeGameplay;
    public static MCH_ConfigPrm EnableWGCoreIntegration;
    public static MCH_ConfigPrm EconomyKeepOnDeath;
    ...
    public static MCH_ConfigPrm GunnerPlaneSearchRadiusAir;
    public static MCH_ConfigPrm GunnerPlaneSearchRadiusGround;
    public static MCH_ConfigPrm GunnerPlaneSearchAltitudeWindow;
    public static MCH_ConfigPrm GunnerPlaneStateSearchMin;
    public static MCH_ConfigPrm GunnerPlaneStateSearchMax;
    public static MCH_ConfigPrm GunnerPlaneStateFocusMin;
    public static MCH_ConfigPrm GunnerPlaneStateFocusMax;
    public static MCH_ConfigPrm GunnerPlaneStateAttackMin;
    public static MCH_ConfigPrm GunnerPlaneStateAttackMax;
    public static MCH_ConfigPrm GunnerPlaneStateDisengageMin;
    public static MCH_ConfigPrm GunnerPlaneStateDisengageMax;
    ...
    public MCH_Config(String minecraftPath, String cfgFile) {
        ...
        EnableTechTreeGameplay = new MCH_ConfigPrm("EnableTechTreeGameplay", false);
        EnableTechTreeGameplay.desc = ";EnableTechTreeGameplay = false: disable tech tree GUI/actions and economy rewards from kills";
        EnableWGCoreIntegration = new MCH_ConfigPrm("EnableWGCoreIntegration", true);
        EnableWGCoreIntegration.desc = ";EnableWGCoreIntegration = true: use WGCore protections when WGCore is installed; otherwise use native MCHeli behavior";
        EconomyKeepOnDeath = new MCH_ConfigPrm("EconomyKeepOnDeath", true);
        EconomyKeepOnDeath.desc = ";EconomyKeepOnDeath = true: keep SL/GE/RP on death; false: reset by death clone";
        ...
        AutoThrottleDownPlane = new MCH_ConfigPrm("AutoThrottleDownPlane", true);
        AutoThrottleDownTank = new MCH_ConfigPrm("AutoThrottleDownTank", true);
        ...
        DespawnCount = new MCH_ConfigPrm("DespawnCount", 5);
        ...
        GunnerPlaneSearchRadiusAir = new MCH_ConfigPrm("GunnerPlaneSearchRadiusAir", 500);
        GunnerPlaneSearchRadiusGround = new MCH_ConfigPrm("GunnerPlaneSearchRadiusGround", 320);
        GunnerPlaneSearchAltitudeWindow = new MCH_ConfigPrm("GunnerPlaneSearchAltitudeWindow", 260);
        GunnerPlaneStateSearchMin = new MCH_ConfigPrm("GunnerPlaneStateSearchMin", 40);
        GunnerPlaneStateSearchMax = new MCH_ConfigPrm("GunnerPlaneStateSearchMax", 120);
        GunnerPlaneStateFocusMin = new MCH_ConfigPrm("GunnerPlaneStateFocusMin", 20);
        GunnerPlaneStateFocusMax = new MCH_ConfigPrm("GunnerPlaneStateFocusMax", 50);
        GunnerPlaneStateAttackMin = new MCH_ConfigPrm("GunnerPlaneStateAttackMin", 80);
        GunnerPlaneStateAttackMax = new MCH_ConfigPrm("GunnerPlaneStateAttackMax", 180);
        GunnerPlaneStateDisengageMin = new MCH_ConfigPrm("GunnerPlaneStateDisengageMin", 100);
        GunnerPlaneStateDisengageMax = new MCH_ConfigPrm("GunnerPlaneStateDisengageMax", 220);
        FixVehicleAtPlacedPoint = new MCH_ConfigPrm("FixVehicleAtPlacedPoint", true);
        KillPassengersWhenDestroyed = new MCH_ConfigPrm("KillPassengersWhenDestroyed", true);
    ...
    public void correctionParameter() {
        ...
        GunnerPlaneSearchRadiusAir.prmInt = Math.max(1, GunnerPlaneSearchRadiusAir.prmInt);
        GunnerPlaneSearchRadiusGround.prmInt = Math.max(1, GunnerPlaneSearchRadiusGround.prmInt);
        GunnerPlaneSearchAltitudeWindow.prmInt = Math.max(0, GunnerPlaneSearchAltitudeWindow.prmInt);
        GunnerPlaneStateSearchMin.prmInt = Math.max(1, GunnerPlaneStateSearchMin.prmInt);
        GunnerPlaneStateSearchMax.prmInt = Math.max(GunnerPlaneStateSearchMin.prmInt, GunnerPlaneStateSearchMax.prmInt);
        GunnerPlaneStateFocusMin.prmInt = Math.max(1, GunnerPlaneStateFocusMin.prmInt);
        GunnerPlaneStateFocusMax.prmInt = Math.max(GunnerPlaneStateFocusMin.prmInt, GunnerPlaneStateFocusMax.prmInt);
        GunnerPlaneStateAttackMin.prmInt = Math.max(1, GunnerPlaneStateAttackMin.prmInt);
        GunnerPlaneStateAttackMax.prmInt = Math.max(GunnerPlaneStateAttackMin.prmInt, GunnerPlaneStateAttackMax.prmInt);
        GunnerPlaneStateDisengageMin.prmInt = Math.max(1, GunnerPlaneStateDisengageMin.prmInt);
        GunnerPlaneStateDisengageMax.prmInt = Math.max(GunnerPlaneStateDisengageMin.prmInt, GunnerPlaneStateDisengageMax.prmInt);
        if (var10) {
